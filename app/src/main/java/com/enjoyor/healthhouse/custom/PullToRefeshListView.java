 ...
 */
public class PullToRefeshListView extends ListView implements AbsListView.OnScrollListener {
    ...
    public PullToRefeshListView(Context context) {
        super(context);
        init(context);
    }

    public PullToRefeshListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void changeHeaderViewByState() {
        switch (state) {
            ...
            case DONE:
                ...
                lvHeaderProgressBar.setVisibility(View.GONE);
                lvHeaderArrowIv.clearAnimation();
                lvHeaderArrowIv.setImageResource(R.mipmap.xlistview_arrow);
                lvHeaderTipsTv.setText("下拉刷新");
                lvHeaderLastUpdatedTv.setVisibility(View.VISIBLE);
                break;
        }
